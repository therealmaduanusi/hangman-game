  ...
  return (
    <div className={`flex flex-col gap-y-[1rem] md:gap-y-[10rem]`}>
      <div className={`flex items-center max-sm:justify-between`}>
        <div onClick={onHandleCategory} className={`block bg-gradient-to-b from-[#FE71FE] to-[#7199FF] w-[4rem] h-[4rem] flex justify-center items-center rounded-[50%] cursor-pointer`} to='/'>
